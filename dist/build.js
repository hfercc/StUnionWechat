...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BottomBar = __webpack_require__(111);

	var _BottomBar2 = _interopRequireDefault(_BottomBar);

	var _vote = __webpack_require__(129);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../css-loader/index.js!./../../../../vue-loader/lib/style-rewriter.js!./../../../../less-loader/index.js!./../../../../vue-loader/lib/selector.js?type=style&index=0!./index.vue", function() {
				var newContent = require("!!./../../../../css-loader/index.js!./../../../../vue-loader/lib/style-rewriter.js!./../../../../less-loader/index.js!./../../../../vue-loader/lib/selector.js?type=style&index=0!./index.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inlineDesc = __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(56)(IteratorPrototype, __webpack_require__(86)('iterator'), function () {
	  return this;
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/navbar/BottomBar.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-6dfd25dc/BottomBar.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tabbar = __webpack_require__(113);

	exports.default = {
	    components: {
	        Tabbar: _tabbar.Tabbar, TabbarItem: _tabbar.TabbarItem
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tabbar = __webpack_require__(114);

	var _tabbar2 = _interopRequireDefault(_tabbar);

	var _tabbarItem = __webpack_require__(120);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] node_modules/vux/src/components/tabbar/tabbar.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../css-loader/index.js!./../../../../vue-loader/lib/style-rewriter.js!./../../../../less-loader/index.js!./../../../../vue-loader/lib/selector.js?type=style&index=0!./tabbar.vue", function() {
				var newContent = require("!!./../../../../css-loader/index.js!./../../../../vue-loader/lib/style-rewriter.js!./../../../../less-loader/index.js!./../../../../vue-loader/lib/selector.js?type=style&index=0!./tabbar.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _multiItems = __webpack_require__(118);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] node_modules/vux/src/components/tabbar/tabbar-item.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-2fa5e5ce/tabbar-item.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _badge = __webpack_require__(122);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] node_modules/vux/src/components/badge/index.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/forms/vote.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _checker = __webpack_require__(138);

	var _divider = __webpack_require__(149);
	...
	exports.default = {
	    ...
	    components: {
	        ...
	        CheckerItem: _checker.CheckerItem,
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] node_modules/vux/src/components/card/index.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _checker = __webpack_require__(139);

	var _checker2 = _interopRequireDefault(_checker);

	var _checkerItem = __webpack_require__(144);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] node_modules/vux/src/components/checker/checker.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-7c3f8a63/checker.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../css-loader/index.js!./../../../../vue-loader/lib/style-rewriter.js!./../../../../vue-loader/lib/selector.js?type=style&index=0!./checker.vue", function() {
				var newContent = require("!!./../../../../css-loader/index.js!./../../../../vue-loader/lib/style-rewriter.js!./../../../../vue-loader/lib/selector.js?type=style&index=0!./checker.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] node_modules/vux/src/components/checker/checker-item.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-6f533e6d/checker-item.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../css-loader/index.js!./../../../../vue-loader/lib/style-rewriter.js!./../../../../less-loader/index.js!./../../../../vue-loader/lib/selector.js?type=style&index=0!./checker-item.vue", function() {
				var newContent = require("!!./../../../../css-loader/index.js!./../../../../vue-loader/lib/style-rewriter.js!./../../../../less-loader/index.js!./../../../../vue-loader/lib/selector.js?type=style&index=0!./checker-item.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./vote.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./vote.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.item-default {\n    border-radius: 3px;\n    display: block;\n    padding: 10px 15px 10px 15px;\n    border: 1px solid #cccccc;\n}\n.item-selected {\n    display: block;\n    background-color: #4ebe78;\n    color: white;\n    padding: 10px 15px 10px 15px;\n    border: 1px solid #4ebe78;\n}\n.item-disabled {\n    border: 1px dashed #000000;\n}\n", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<checker :value.sync=\"selected\" type=\"checkbox\" default-item-class=\"item-default\"\n         selected-item-class=\"item-selected\" disabled-item-class=\"item-disabled\">\n    <checker-item :value=\"1\">\n        <img src=\"http://placeholder.qiniudn.com/300x300/000000/ffffff\">\n        <p style=\"text-align: center;margin:5px 0px;border-top:1px solid #cccccc; padding-top: 10px\">参赛选手1</p>\n        <p style=\"text-align: center;margin:5px 0px;\">\n            演唱曲目 < 1 > </p>\n    </checker-item>\n    <checker-item :value=\"2\" disabled>\n        <img src=\"http://placeholder.qiniudn.com/300x300/000000/ffffff\">\n        <p style=\"text-align: center;margin:5px 0px;border-top:1px solid #cccccc; padding-top: 10px\">参赛选手2</p>\n        <p style=\"text-align: center;margin:5px 0px;\">演唱曲目 < 2 > </p>\n        <progress :percent=\"10\" :show-cancel=\"false\" style=\"margin-top:10px \"></progress>\n        <p style=\"margin:5px 0px;color: #aaaaaa;\">1000 (10%)</p>\n    </checker-item>\n</checker>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] node_modules/vux/src/components/progress/index.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _base = __webpack_require__(177);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mixin_uuid = __webpack_require__(178);
